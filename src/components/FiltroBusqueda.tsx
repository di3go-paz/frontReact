  ...
  return (
    <div className="flex gap-2 mb-4">
      <select
        ...
        className="border border-gray-300 bg-white text-gray-700 p-2 rounded"
      >
      ...
      <input
        ...
        className="border border-gray-300 bg-white text-gray-700 placeholder-gray-400 p-2 rounded flex-1"
      />
    </div>
  );
};
